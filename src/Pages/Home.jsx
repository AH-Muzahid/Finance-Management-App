...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-base-100 pt-16">
            ...
            {/* Stats Section - Show Skeleton if Loading */}
                    ...
                    <div className="bg-gray-50 dark:bg-base-100 py-15">
                        <div className="max-w-[1220px] mx-auto px-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                                ...
                                {/* Net Balance */}
                                <div className={`bg-linear-to-br rounded-xl p-6 border ${balance >= 0
                                    ...
                                    <div className="flex items-center justify-between mb-4">
                                        <div className={`w-12 h-12 rounded-full flex items-center justify-center ${balance >= 0 ? 'bg-blue-500' : 'bg-orange-500'
                                            }`}>
                                            <FaDollarSign className="text-white text-xl" />
                                        </div>
                                        <span className={`text-sm font-medium ${balance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'
                                            }`}>TOTAL BALANCE</span>
                                    </div>
                                    <h3 className={`text-3xl font-bold mb-2 ${balance >= 0 ? 'text-blue-700 dark:text-blue-300' : 'text-orange-700 dark:text-orange-300'
                                        }`}>
                                        BDT  {balance.toLocaleString()}
                                    </h3>
                                    <p className={`text-sm ${balance >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'
                                        }`}>
