                ...
                <div className="navbar-end flex items-center gap-3">
                    ...
                    {user ? (
                            ...
                            >
                                <div className="w-8 h-8 rounded-full ring-2 ring-primary-500/20">
                                    {user.photoURL ? (
                                        ...
                                        <div className="bg-primary-500 w-full h-full flex items-center justify-center rounded-full">
                        ...
                        <div className="hidden md:flex gap-2">
                            ...
                            <Link to="/register" className="bg-primary-500 text-white hover:bg-primary-600 px-4 py-2 rounded-lg font-semibold transition-all shadow-lg shadow-primary-500/30">Sign Up</Link>
                        </div>
                    )}
                </div>
            </div>
                    ...
                    {user ? (
                        ...
                        <>
                            ...
                            <Link
                                to="/register"
                                onClick={() => setIsMobileMenuOpen(false)}
                                className="block px-4 py-3 rounded-lg bg-primary-500 text-white hover:bg-primary-600 transition-all text-center font-semibold shadow-lg shadow-primary-500/30"
                            >
                                Sign Up
                            </Link>
                        </>
